...
public class ImmutableQueue<E> {
	...
	private ImmutableQueue(SList<E> front, SList<E> rear) {
		//loop inviarant: front is empty when and only when rear is also empty
	...
	public ImmutableQueue<E> enqueue(E e){
		...
		return new ImmutableQueue<E>(front, rear.addHead(e));
	}
	...
	public ImmutableQueue<E> dequeue() {
		...
		return new ImmutableQueue<E>(front.removeHead(), rear);
	}
